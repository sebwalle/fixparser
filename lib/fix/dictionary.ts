/**
 * FIX 4.4 Tag Dictionary - Complete Field Reference
 *
 * Comprehensive mapping of FIX protocol tag numbers to human-readable names.
 * Source: https://www.onixs.biz/fix-dictionary/4.4/fields_by_tag.html
 *
 * This dictionary includes all standard FIX 4.4 tags (1-956+) covering:
 ...
 * - Allocation
 * - Trading sessions
 * - And all other FIX 4.4 protocol fields
 */
...
export const TAG_DICTIONARY: Record<string, string> = {
  ...
  // Custom/User-Defined Tags (10000+ range - commonly used for proprietary extensions)
  '10009': 'NoCustomGroups',
  '10010': 'CustomFieldName',
  '10011': 'CustomFieldValue',
};
...
export function getTagName(tag: string): string {
  return TAG_DICTIONARY[tag] || `Tag${tag}`;
}

/**
 * Common message type codes (tag 35)
 */
...
/**
 * Order type codes (tag 40)
 */
export const ORD_TYPE_CODES: Record<string, string> = {
  '1': 'Market',
  '2': 'Limit',
  '3': 'Stop',
  '4': 'Stop Limit',
...
/**
 * Time in force codes (tag 59)
 */
export const TIME_IN_FORCE_CODES: Record<string, string> = {
  '0': 'Day',
  '1': 'Good Till Cancel',
  '2': 'At The Opening',
...
/**
 * Security type codes (tag 167)
 */
export const SECURITY_TYPE_CODES: Record<string, string> = {
...
/**
 * Party ID source codes (tag 447)
 */
export const PARTY_ID_SOURCE_CODES: Record<string, string> = {
  'A': 'BIC',
  'B': 'Generally Accepted Market Participant Identifier',
  'C': 'Proprietary',
  'D': 'ISO Country Code',
  'E': 'Settlement Entity Location',
  'F': 'MIC',
  'G': 'CSD Participant Member Code',
  'H': 'Korean Investor ID',
  'I': 'Taiwanese Qualified Foreign Investor ID',
...
/**
 * Party role codes (tag 452)
 */
export const PARTY_ROLE_CODES: Record<string, string> = {
  '1': 'Executing Firm',
  '2': 'Broker of Credit',
  '3': 'Client ID',
  '4': 'Clearing Firm',
...
/**
 * Maps tag numbers to their corresponding value code dictionaries
 */
const TAG_VALUE_DICTIONARIES: Record<string, Record<string, string>> = {
  '35': MSG_TYPES,
  '39': ORD_STATUS_CODES,
  '40': ORD_TYPE_CODES,
  '54': SIDE_CODES,
  '59': TIME_IN_FORCE_CODES,
  '150': EXEC_TYPE_CODES,
  '167': SECURITY_TYPE_CODES,
  '447': PARTY_ID_SOURCE_CODES,
  '452': PARTY_ROLE_CODES,
};

/**
 * Gets a human-readable description for a field value if available
 * Returns the original value if no description exists
 *
 * @param tag - The FIX tag number
 * @param value - The field value
 * @returns The value with description if available, e.g., "12 (Executing Trader)" or just "12"
 */
export function getFieldValueDescription(tag: string, value: string): string {
  const dictionary = TAG_VALUE_DICTIONARIES[tag];
  if (!dictionary) {
    return value;
  }
...
/**
 * Gets just the human-readable description for a field value
 ...
 */
export function getValueDescription(tag: string, value: string): string | undefined {
  const dictionary = TAG_VALUE_DICTIONARIES[tag];
